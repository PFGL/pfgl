...
<div class="entry-content cf" itemprop="articleBody">
				        ...
				        <div class="ifa-map">
			<a id="rutherford-wilkinson" onmouseover="hoverTool('rutherford')" ononclick="selectThis('rutherford-wilkinson')" href="javascript:void(0);" class="bullet preview">RutherfordWilkinson</a>
