...
<div class="entry-content cf" itemprop="articleBody">
				        ...
				        <div class="ifa-map">
			<a id="rutherford-wilkinson"  onclick="selectThis('rutherford-wilkinson')" href="javascript:void(0);" class="bullet preview"><img src="/wp-content/themes/pfgl/library/images/rw.jpg" class="map-logo"></a>
